...
def column_selection(callback):
    ...
    general_info = {"Total population year 2018": "Total_pop",
                    ...
                    "Share of days (fraction between 0 and 1) with cloud cover <30% at 11:00UTC year 2018": "share_cloud_over30percent",
                    "Share of days (fraction between 0 and 1) with cloud cover <30% at 11:00UTC year summer (J+J) 2018": "share_cloud_over30percent_summer",
                    "Share of days (fraction between 0 and 1) with cloud cover <30% at 11:00UTC year winter (J+F) 2018": "share_cloud_over30percent_winter"}
    ...
    land_cover_general_info = {  
        ...
        "Share of cropland (ESA Worldcover class 40) in the buffer zone":"40_buffer",
        "Share of cropland (ESA Worldcover class 40) in the buffer zone in the dominant wind direction. Only when wind is >2m/s.":"40_buffer_dom_wind",
    ...
    radiocarbon_info = {
        "Average nuclear contamination winter (J+F) afternoons (12 and 15UTC) in permil": "average_nuclear_contamination_permil_winter",
        ...
        "Average ffCO2 STILT signal winter (J+F) afternoons (12 and 15UTC)": "average_modelled_ffco2_signal_winter",
    ...
    list_vegetation_classes = ['Trees', 'Shrubland', 'Grassland', 'Cropland', 'Built-up', 'Bare / sparse vegetation', 
 'Snow and ice', 'Permanent water bodies', 'Herbaceous wetland', 'Moss and lichen']
    vegetation_checkboxes = []
    for vegetation in list_vegetation_classes:
        checkbox = widgets.Checkbox(
            value=False, 
            description=f'{vegetation} (ESA Worldcover class {land_cover_info[vegetation]})',
    ...
    for hour in range(24):
        checkbox = widgets.Checkbox(
            value=False, 
            description=f'NEE average {hour}:00UTC',
            layout=widgets.Layout(width='90%')
        )
    ...
    for hour in range(24):
        checkbox = widgets.Checkbox(
            value=False, 
            description=f'CO2 offset {hour}:00UTC',
            layout=widgets.Layout(width='90%')
        )
    ...
    for hour in range(24):
        checkbox = widgets.Checkbox(
            value=False, 
            description=f'CO2 emission {hour}:00UTC',
            layout=widgets.Layout(width='90%')
        )
    ...
    def create_subset(change=None):
        ...
        selected_columns += [f'{land_cover_info[vegetation]}' for vegetation, cb in zip(list_vegetation_classes, vegetation_checkboxes) if cb.value]
    ...
    main_accordion.set_title(3, 'Biogenic Activity (winter afternoons)')
...
def display_selected_variables(df):
    ...
    dictionary_all_variables = {'NEE_average_0': 'Average NEE during January and February 2018 at 0:00UTC', 'NEE_average_1': 'Average NEE during January and February 2018 at 1:00UTC', 'NEE_average_2': 'Average NEE during January and February 2018 at 2:00UTC', 'NEE_average_3': 'Average NEE during January and February 2018 at 3:00UTC', 'NEE_average_4': 'Average NEE during January and February 2018 at 4:00UTC', 'NEE_average_5': 'Average NEE during January and February 2018 at 5:00UTC', 'NEE_average_6': 'Average NEE during January and February 2018 at 6:00UTC', 'NEE_average_7': 'Average NEE during January and February 2018 at 7:00UTC', 'NEE_average_8': 'Average NEE during January and February 2018 at 8:00UTC', 'NEE_average_9': 'Average NEE during January and February 2018 at 9:00UTC', 'NEE_average_10': 'Average NEE during January and February 2018 at 10:00UTC', 'NEE_average_11': 'Average NEE during January and February 2018 at 11:00UTC', 'NEE_average_12': 'Average NEE during January and February 2018 at 12:00UTC', 'NEE_average_13': 'Average NEE during January and February 2018 at 13:00UTC', 'NEE_average_14': 'Average NEE during January and February 2018 at 14:00UTC', 'NEE_average_15': 'Average NEE during January and February 2018 at 15:00UTC', 'NEE_average_16': 'Average NEE during January and February 2018 at 16:00UTC', 'NEE_average_17': 'Average NEE during January and February 2018 at 17:00UTC', 'NEE_average_18': 'Average NEE during January and February 2018 at 18:00UTC', 'NEE_average_19': 'Average NEE during January and February 2018 at 19:00UTC', 'NEE_average_20': 'Average NEE during January and February 2018 at 20:00UTC', 'NEE_average_21': 'Average NEE during January and February 2018 at 21:00UTC', 'NEE_average_22': 'Average NEE during January and February 2018 at 22:00UTC', 'NEE_average_23': 'Average NEE during January and February 2018 at 23:00UTC', 'tCO2_offset_per_hour_0': 'Total city-wide NEE during January and February 2018 at 0:00UTC', 'tCO2_offset_per_hour_1': 'Total city-wide NEE during January and February 2018 at 1:00UTC', 'tCO2_offset_per_hour_2': 'Total city-wide NEE during January and February 2018 at 2:00UTC', 'tCO2_offset_per_hour_3': 'Total city-wide NEE during January and February 2018 at 3:00UTC', 'tCO2_offset_per_hour_4': 'Total city-wide NEE during January and February 2018 at 4:00UTC', 'tCO2_offset_per_hour_5': 'Total city-wide NEE during January and February 2018 at 5:00UTC', 'tCO2_offset_per_hour_6': 'Total city-wide NEE during January and February 2018 at 6:00UTC', 'tCO2_offset_per_hour_7': 'Total city-wide NEE during January and February 2018 at 7:00UTC', 'tCO2_offset_per_hour_8': 'Total city-wide NEE during January and February 2018 at 8:00UTC', 'tCO2_offset_per_hour_9': 'Total city-wide NEE during January and February 2018 at 9:00UTC', 'tCO2_offset_per_hour_10': 'Total city-wide NEE during January and February 2018 at 10:00UTC', 'tCO2_offset_per_hour_11': 'Total city-wide NEE during January and February 2018 at 11:00UTC', 'tCO2_offset_per_hour_12': 'Total city-wide NEE during January and February 2018 at 12:00UTC', 'tCO2_offset_per_hour_13': 'Total city-wide NEE during January and February 2018 at 13:00UTC', 'tCO2_offset_per_hour_14': 'Total city-wide NEE during January and February 2018 at 14:00UTC', 'tCO2_offset_per_hour_15': 'Total city-wide NEE during January and February 2018 at 15:00UTC', 'tCO2_offset_per_hour_16': 'Total city-wide NEE during January and February 2018 at 16:00UTC', 'tCO2_offset_per_hour_17': 'Total city-wide NEE during January and February 2018 at 17:00UTC', 'tCO2_offset_per_hour_18': 'Total city-wide NEE during January and February 2018 at 18:00UTC', 'tCO2_offset_per_hour_19': 'Total city-wide NEE during January and February 2018 at 19:00UTC', 'tCO2_offset_per_hour_20': 'Total city-wide NEE during January and February 2018 at 20:00UTC', 'tCO2_offset_per_hour_21': 'Total city-wide NEE during January and February 2018 at 21:00UTC', 'tCO2_offset_per_hour_22': 'Total city-wide NEE during January and February 2018 at 22:00UTC', 'tCO2_offset_per_hour_23': 'Total city-wide NEE during January and February 2018 at 23:00UTC', 'tCO2_rel_emission_per_hour_0': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 0:00UTC', 'tCO2_rel_emission_per_hour_1': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 1:00UTC', 'tCO2_rel_emission_per_hour_2': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 2:00UTC', 'tCO2_rel_emission_per_hour_3': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 3:00UTC', 'tCO2_rel_emission_per_hour_4': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 4:00UTC', 'tCO2_rel_emission_per_hour_5': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 5:00UTC', 'tCO2_rel_emission_per_hour_6': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 6:00UTC', 'tCO2_rel_emission_per_hour_7': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 7:00UTC', 'tCO2_rel_emission_per_hour_8': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 8:00UTC', 'tCO2_rel_emission_per_hour_9': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 9:00UTC', 'tCO2_rel_emission_per_hour_10': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 10:00UTC', 'tCO2_rel_emission_per_hour_11': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 11:00UTC', 'tCO2_rel_emission_per_hour_12': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 12:00UTC', 'tCO2_rel_emission_per_hour_13': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 13:00UTC', 'tCO2_rel_emission_per_hour_14': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 14:00UTC', 'tCO2_rel_emission_per_hour_15': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 15:00UTC', 'tCO2_rel_emission_per_hour_16': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 16:00UTC', 'tCO2_rel_emission_per_hour_17': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 17:00UTC', 'tCO2_rel_emission_per_hour_18': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 18:00UTC', 'tCO2_rel_emission_per_hour_19': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 19:00UTC', 'tCO2_rel_emission_per_hour_20': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 20:00UTC', 'tCO2_rel_emission_per_hour_21': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 21:00UTC', 'tCO2_rel_emission_per_hour_22': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 22:00UTC', 'tCO2_rel_emission_per_hour_23': 'Relative NEE during January and February 2018 compared to total CO2 emissions at 23:00UTC', 'Total_pop': 'Total population year 2018', 'area_50percent_pop': 'Share of the city containing 50% of the population', 'area': 'Area in km2', 'dist_closest_city': 'Distance to closest city in km', 'share_over_2m_s':'Share of times the wind is >2m/s Jan/Feb 2018 hours 9 - 18','dominant_wind_share': 'Share of wind from dominant wind direction Jan/Feb 2018 hours 9 - 18 when wind is >2m/s', 'emiss_intensity_buff_dom_wind_jan_feb_9_18_2m_s': 'Emission intensity (kg CO2 / km2) within 20km buffer in the dominant wind direction (Jan/Feb 2018 hours 9 - 18). Only when wind is >2m/s.', 'share_cloud_over30percent':'Share of days (fraction between 0 and 1) with cloud cover <30% at 11:00UTC year 2018','share_cloud_over30percent_summer':'Share of days (fraction between 0 and 1) with cloud cover <30% at 11:00UTC summer (J+J) year 2018', 'share_cloud_over30percent_winter':'Share of days (fraction between 0 and 1) with cloud cover <30% at 11:00UTC winter (J+F) year 2018','vegetation': 'Share of vegetation (%)', 'veg_share_edge_area': "The percent of edge cells for vegetated areas", 'share_water_buffer': 'Share of water in the buffer zone', '40_buffer':'Share of cropland (ESA Worldcover class 40) in the buffer zone', '40_buffer_dom_wind':'Share of cropland (ESA Worldcover class 40) in the buffer zone in the dominant wind direction. Only when wind is >2m/s.','share_vegetation_buffer': 'Share of vegetation in the buffer zone', '10': 'Trees (ESA Worldcover class 10)', '20':'Shrubland (ESA Worldcover class 20)', '30':'Grassland (ESA Worldcover class 30)', '40':'Cropland (ESA Worldcover class 40)', '50': 'Built-up (ESA Worldcover class 50)', '60': 'Bare / sparse vegetation (ESA Worldcover class 60)', '70':'Snow and ice (ESA Worldcover class 70)', '80': 'Permanent water bodies (ESA Worldcover class 80)', '90': 'Herbaceous wetland (ESA Worldcover class 90)', '100':'Moss and lichen (ESA Worldcover class 100)', 'co2_ff_total': 'Total emissions 2018 (kg)', 'co2_ff_total_km2': 'Total emissions 2018 per km2', 'co2_ff_total_pop': 'Total emission 2018 per person', 'co2_ff_share_point_sources_total': 'Share of point source emissions', 'co2_ff_total_no_point': 'Total non-point source emissions 2018 (kg)', 'co2_ff_total_no_point_km2': 'Total non-point emission per km²', 'co2_ff_total_no_point_pop': 'Total non-point source emissions 2018', 'area_percentage': 'Share of city area containing 50% of the emissions', 'co2_ff_total_20km_buffer_km2': 'Emission intensity 20km buffer zone', 'co2_ff_total_20km_buffer_share_point_sources': 'Share of point sources in the buffer zone', 'co2_ff_total_20km_buffer_count_point_sources': 'Count point sources in the buffer zone', 'co2_ff_A_share': 'Public power (total share)', 'co2_ff_share_point_sources_A': 'Public power (share point sources)', 'co2_ff_count_point_sources_A': 'Public power (count point sources)', 'co2_ff_B_share': 'Industry (total share)', 'co2_ff_share_point_sources_B': 'Industry (share point sources)', 'co2_ff_count_point_sources_B': 'Industry (count point sources)', 'co2_ff_C_share': 'Other stationary combustions (total share)', 'co2_ff_F_share': 'Road transport (total share)', 'co2_ff_G_share': 'Shipping (total share)', 'share_uncertainty_total': 'Spatial uncertainty: % of the emissions', 'co2_ff_total_ODIAC': 'Total emissions 2018 ODIAC (kg)', 'mean_built_up': 'Mean building height in meters (based on a dataset with 100x100m grids)', 'share_flatness': 'Share of flat areas (classes 24 and 34)', 'Mean_20contour': 'Average size of patches in km2 where elevation is within 20m', 'Std_20contour': 'Standard deviation of patch sizes where elevation is within 20m', 'Var_20contour': 'Variability of patch sizes where elevation is within 20m', 'Mean_TRI': 'Average Terrain Ruggedness index', 'average_nuclear_contamination_permil_winter': 'Average nuclear contamination winter (J+F) afternoons (12 and 15 UTC)', 'share_daily_average_over_0_5_permil_winter':'Share of days >0.5 permil nuclear contamination winter', 'share_daily_average_over_0_3_permil_winter': 'Share of days >0.3 permil nuclear contamination winter', 'average_modelled_ffco2_signal_winter': 'Average ffCO2 STILT signal winter', 'average_modelled_ffco2_signal_days_below_0_5permil_winter': 'Average ffCO2 STILT signal on days >0.5 permil nuclear contamination winter', 'nuclear_masking_potential_winter': 'Average nuclear masking potential winter (%)', 'representation_bias_sample_selection_winter': 'Average representation bias due to sample selection (>0.5 permil) winter (%)'}
...
def create_dendrogram(similarity_matrix, callback):
    ...
    def run_dendrogram(*args):
        # Fixed linkage method (always 'ward')
        dendrogram_link = 'ward'
        ...
        for threshold in np.arange(range_from, range_until, 0.005):
            # Generate flat clusters at the current threshold
            flat_clusters = fcluster(linkage_matrix, t=threshold, criterion='distance')
            num_clusters = len(set(flat_clusters))
        ...
        flat_clusters = fcluster(linkage_matrix, t=threshold_num_desired_clusters, criterion='distance')
        actual_num_clusters = list_num_clusters[closest_index]
        ...
        with output:
            ...
            if actual_num_clusters != target_clusters:
                display(HTML(f"<b>Unable to create desired number of clusters ({target_clusters}). "
                             f"Closest possible number of clusters ({actual_num_clusters}) was selected.</b>"))
    ...
    # Display the widgets
    display(target_clusters_input, save_dendrogram_checkbox, create_button, output)
