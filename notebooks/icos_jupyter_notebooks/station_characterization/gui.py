...
header_other = Output()
with header_other:
    display(HTML('<p style="font-size:15px;font-weight:bold;"><br>Other specifications: </p>'))
...
with form_out:
    ...
    display(settings_grid_1,settings_grid_2,settings_grid_3,settings_grid_4,settings_grid_5,settings_grid_6,settings_grid_7,settings_grid_8, progress_bar, header_no_footprints, h_box_1, grid, h_box_2, h_box_3, grid_2, header_download)
