...
def _template():
    ...
    tex = """
        ...
        **name** station characterisation
        ...
        \\begin{large}
        \\bigskip
The station characterisation is based on STILT model footprints, an anthropogenic emission inventory, a biogenic flux model and ancillary data layers. More detailed information on the data source and processing is provided at the end of this document.\n
...
The following figures present more advanced syntheses, so please carefully read the explanations. Please read the specification section at the end of this document for further information and explanations.
